 ...
 */
import type { SessionBase } from './session-base';
/**
 * 
 * @export
 * @interface RelatedSessionsSession
 */
export interface RelatedSessionsSession {
    /**
     * 
     * @type {Array<SessionBase>}
     * @memberof RelatedSessionsSession
     */
    data: Array<SessionBase>;
}
