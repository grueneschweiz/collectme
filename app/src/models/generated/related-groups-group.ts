 ...
 */
import type { GroupBase } from './group-base';
/**
 * 
 * @export
 * @interface RelatedGroupsGroup
 */
export interface RelatedGroupsGroup {
    /**
     * 
     * @type {Array<GroupBase>}
     * @memberof RelatedGroupsGroup
     */
    data: Array<GroupBase>;
}
