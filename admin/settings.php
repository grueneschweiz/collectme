        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <code>[collectme name="<?php echo esc_attr($cause->name); ?>" causeuuid="<?php echo esc_attr($cause->uuid); ?>"]</code>
                    <p class="description">
                        <?php _e('Paste shortcode into the post or page where you want the collectme app to run.', 'collectme') ?>
                    </p>
                    <form method="post" onsubmit="return confirm('<?php printf(esc_attr__('Do you really want to delete %s and all its associated data? Only do this if the cause is long past or was never launched.', 'collectme'), $cause->name) ?>');">
            ...
            <tr>
                ...
                <td>
                    <form method="post">
                        ...
                        <input type="text" class="regular-text" id="create-cause" name="create-cause" value="" maxlength="45" minlength="2">
                        <p class="description"><?php _e('The name is only for internal use and not visible to the public. Keep it short.', 'collectme') ?></p>
                        <p><input type="submit" name="submit" id="submit" class="button button-primary" value="<?php esc_attr_e('Create cause', 'collectme') ?>"></p>
                    </form>
                </td>
            </tr>
        </tbody>
        ...
        <table class="form-table" role="presentation">
            ...
            <tr>
                <th scope="row">
                    ...
                    <p style="font-weight: normal; color: red;"><?php _e('Caution: Changing the goals after launching the cause will break the user experience.', 'collectme') ?></p>
                </th>
                <td>
