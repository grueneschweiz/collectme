      ...
      <div class="collectme-base-step-element__icon">
        ...
        >
          ...
          >
            ...
            <path
              d="M25 13L22.56 10.22L22.9 6.53998L19.29 5.71998L17.4 2.53998L14 3.99998L10.6 2.53998L8.71 5.71998L5.1 6.52998L5.44 10.21L3 13L5.44 15.78L5.1 19.47L8.71 20.29L10.6 23.47L14 22L17.4 23.46L19.29 20.28L22.9 19.46L22.56 15.78L25 13ZM12 18L8 14L9.41 12.59L12 15.17L18.59 8.57998L20 9.99998L12 18Z"
            />
          </mask>
          <path
            d="M25 13L22.56 10.22L22.9 6.53998L19.29 5.71998L17.4 2.53998L14 3.99998L10.6 2.53998L8.71 5.71998L5.1 6.52998L5.44 10.21L3 13L5.44 15.78L5.1 19.47L8.71 20.29L10.6 23.47L14 22L17.4 23.46L19.29 20.28L22.9 19.46L22.56 15.78L25 13ZM12 18L8 14L9.41 12.59L12 15.17L18.59 8.57998L20 9.99998L12 18Z"
          ...
          <path
            ...
            stroke="#F1F1F1"
            stroke-width="4"
            mask="url(#path-1-outside-1_37_168)"
          />
        </svg>
        ...
        >
          <path
            d="M25 14L22.56 11.22L22.9 7.53998L19.29 6.71998L17.4 3.53998L14 4.99998L10.6 3.53998L8.71 6.71998L5.1 7.52998L5.44 11.21L3 14L5.44 16.78L5.1 20.47L8.71 21.29L10.6 24.47L14 23L17.4 24.46L19.29 21.28L22.9 20.46L22.56 16.78L25 14ZM12 19L8 15L9.41 13.59L12 16.17L18.59 9.57998L20 11L12 19Z"
            fill="#F1F1F1"
          />
          <mask
            id="path-2-outside-1_37_166"
            maskUnits="userSpaceOnUse"
            x="0"
            y="0.5"
            width="28"
          ...
          >
            ...
            <path
              d="M25 14L22.6 11.2L22.9 7.5L19.3 6.7L17.4 3.5L14 5L10.6 3.5L8.7 6.7L5.1 7.5L5.4 11.2L3 14L5.4 16.8L5.1 20.5L8.7 21.3L10.6 24.5L14 23L17.4 24.5L19.3 21.3L22.9 20.5L22.6 16.8L25 14ZM20.7 18.9L18 19.5L16.6 21.9L14 20.8L11.4 21.9L10 19.5L7.3 18.9L7.5 16.1L5.7 14L7.5 11.9L7.3 9.1L10 8.5L11.4 6.1L14 7.2L16.6 6.1L18 8.5L20.7 9.1L20.5 11.9L22.3 14L20.5 16.1L20.7 18.9ZM18.6 9.6L20 11L12 19L8 15L9.4 13.6L12 16.2L18.6 9.6Z"
            />
          </mask>
          <path
            d="M25 14L22.6 11.2L22.9 7.5L19.3 6.7L17.4 3.5L14 5L10.6 3.5L8.7 6.7L5.1 7.5L5.4 11.2L3 14L5.4 16.8L5.1 20.5L8.7 21.3L10.6 24.5L14 23L17.4 24.5L19.3 21.3L22.9 20.5L22.6 16.8L25 14ZM20.7 18.9L18 19.5L16.6 21.9L14 20.8L11.4 21.9L10 19.5L7.3 18.9L7.5 16.1L5.7 14L7.5 11.9L7.3 9.1L10 8.5L11.4 6.1L14 7.2L16.6 6.1L18 8.5L20.7 9.1L20.5 11.9L22.3 14L20.5 16.1L20.7 18.9ZM18.6 9.6L20 11L12 19L8 15L9.4 13.6L12 16.2L18.6 9.6Z"
          ...
          <path
            ...
            stroke="#F1F1F1"
            stroke-width="4"
            mask="url(#path-2-outside-1_37_166)"
          />
        </svg>
        ...
        >
          ...
          <path
            ...
            stroke="#F1F1F1"
            stroke-width="4"
            mask="url(#path-1-outside-1_37_136)"
          />
        </svg>
      </div>
    </div>
...
const liveLineClasses = computed(() => {
  ...
  if (props.next) {
    classes.push(
      "collectme-base-step-element__indicator__liveline--after--" + props.next
    );
  }
