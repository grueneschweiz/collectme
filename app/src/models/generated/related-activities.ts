 ...
 */
import type { RelatedActivitiesActivity } from './related-activities-activity';
/**
 * 
 * @export
 * @interface RelatedActivities
 */
export interface RelatedActivities {
    /**
     * 
     * @type {RelatedActivitiesActivity}
     * @memberof RelatedActivities
     */
    activity: RelatedActivitiesActivity;
}
