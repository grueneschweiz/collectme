 ...
 */
import type { RelatedObjectivesObjective } from './related-objectives-objective';
/**
 * 
 * @export
 * @interface RelatedObjectives
 */
export interface RelatedObjectives {
    /**
     * 
     * @type {RelatedObjectivesObjective}
     * @memberof RelatedObjectives
     */
    objective: RelatedObjectivesObjective;
}
