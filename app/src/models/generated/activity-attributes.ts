...
export interface ActivityAttributes {
     ...
     */
    type: ActivityAttributesTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof ActivityAttributes
...
/**
    ...
    * @enum {string}
    */
export enum ActivityAttributesTypeEnum {
    Pledge = 'pledge',
    PersonalSignature = 'personal signature',
    OrganizationSignature = 'organization signature',
    PersonalGoalAchieved = 'personal goal achieved',
    PersonalGoalRaised = 'personal goal raised'
}
