 ...
 */
import type { ActivityBase } from './activity-base';
/**
 * 
 * @export
 * @interface RelatedActivitiesActivity
 */
export interface RelatedActivitiesActivity {
    /**
     * 
     * @type {Array<ActivityBase>}
     * @memberof RelatedActivitiesActivity
     */
