 ...
 */
import type { SignatureBase } from './signature-base';
/**
 * 
 * @export
 * @interface RelatedSignaturesSignature
 */
export interface RelatedSignaturesSignature {
    /**
     * 
     * @type {Array<SignatureBase>}
     * @memberof RelatedSignaturesSignature
     */
    data: Array<SignatureBase>;
}
