 ...
 */
import type { ObjectiveBase } from './objective-base';
/**
 * 
 * @export
 * @interface RelatedObjectivesObjective
 */
export interface RelatedObjectivesObjective {
    /**
     * 
     * @type {Array<ObjectiveBase>}
     * @memberof RelatedObjectivesObjective
     */
    data: Array<ObjectiveBase>;
}
