 ...
 */
import type { RelatedCausesCause } from './related-causes-cause';
/**
 * 
 * @export
 * @interface RelatedCauses
 */
export interface RelatedCauses {
    /**
     * 
     * @type {RelatedCausesCause}
     * @memberof RelatedCauses
     */
    cause: RelatedCausesCause;
}
