 ...
 */
import type { RelatedSignaturesSignature } from './related-signatures-signature';
/**
 * 
 * @export
 * @interface RelatedSignatures
 */
export interface RelatedSignatures {
    /**
     * 
     * @type {RelatedSignaturesSignature}
     * @memberof RelatedSignatures
     */
    signature: RelatedSignaturesSignature;
}
