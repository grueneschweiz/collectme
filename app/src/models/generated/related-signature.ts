 ...
 */
import type { RelatedSignatureSignature } from './related-signature-signature';
/**
 * 
 * @export
 * @interface RelatedSignature
 */
export interface RelatedSignature {
    /**
     * 
     * @type {RelatedSignatureSignature}
     * @memberof RelatedSignature
     */
    signature: RelatedSignatureSignature;
}
